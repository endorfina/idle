...
namespace gl
{
    ...
    typedef void (CODEGEN_FUNCPTR *PFNBINDVERTEXARRAY)(GLuint ren_);
    ...
    typedef void (CODEGEN_FUNCPTR *PFNDEPTHRANGE)(GLdouble ren_, GLdouble ren_);
    ...
    PFNISSYNC IsSync = 0;
    typedef GLboolean (CODEGEN_FUNCPTR *PFNISVERTEXARRAY)(GLuint ren_);
...
#else
        static constexpr int g_major_version = 2;
        static constexpr int g_minor_version = 0;
